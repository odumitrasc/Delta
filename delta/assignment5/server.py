...
class Server:
 ...
 def _wait_for_connections(self):
     ...
     while True:
         ...
         elif (request_method == 'POST' and file_requested == "www/webclient.html"):
             serverInput = input("server input: ")
             conn.sendall(bytes(self._gen_headers(200) + serverInput, "UTF-8"))
             conn.close()
             continue
         else:
